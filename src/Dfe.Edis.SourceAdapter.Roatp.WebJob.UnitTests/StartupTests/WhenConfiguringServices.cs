...
namespace Dfe.Edis.SourceAdapter.Roatp.WebJob.UnitTests.StartupTests
{
    public class WhenConfiguringServices
    {
        ...
        private RootAppConfiguration GetTestConfiguration()
        {
            ...
            {
                SourceData = new SourceDataConfiguration
                {
